OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/lexer.o ./build/token.o ./build/lex_process.o ./build/parser.o ./build/scope.o ./build/datatype.o ./build/node.o ./build/symresolver.o ./build/expressionable.o ./build/helpers/buffer.o ./build/helpers/vector.o
INCLUDES = -I ./
