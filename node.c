...
struct node* node_create(struct node* _node)
{
    ...
    #warning "we should set the binded owner and binden function here"!
    node_push(node);
    return node;
}
...
// Takes the specific type out of the variable
...
#warning "Union type variable nodes are not implemented yet"
            break;
    }
    return var_node;
}
